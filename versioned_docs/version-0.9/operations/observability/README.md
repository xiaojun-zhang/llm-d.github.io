...
Scripts, Grafana dashboard JSON, alerting rules, and tracing manifests live in [`guides/recipes/observability/`](https://github.com/llm-d/llm-d/tree/main/guides/recipes/observability/) in the llm-d repository (not published as website pages).
