...
Follow the [well-lit path guides](https://github.com/llm-d/llm-d/tree/main/guides/) to deploy llm-d workloads. Each guide includes OpenShift-specific steps where applicable.
